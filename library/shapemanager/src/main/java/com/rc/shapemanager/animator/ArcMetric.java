...
public class ArcMetric {
    ...
    private PointF mAxisPoint[] = new PointF[2];
    ...
    private float mMidAxisSegment;

    private float mZeroStartSegment;

    //DEGREES.

    private float mAnimationDegree;

    private float mSideDegree;

    private float mZeroStartDegree;
