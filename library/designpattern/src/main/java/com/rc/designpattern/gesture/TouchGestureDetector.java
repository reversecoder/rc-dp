package com.rc.designpattern.gesture;
...
public class TouchGestureDetector {
    ...
    /**
     * The Class TouchGestureAdapter.
     */
    class TouchGestureAdapter implements TouchGestureListener {

        /*
         * (non-Javadoc)
         *
         * @see
         * pl.polidea.test.TouchGestureDetector.TouchGestureListener#onShowPress
         * ()
         */
        @Override
         ...
         *
         * @see
         * pl.polidea.test.TouchGestureDetector.TouchGestureListener#onSingleTapUp
         * ()
         */
        @Override
         ...
         *
         * @see
         * pl.polidea.test.TouchGestureDetector.TouchGestureListener#onDrag()
         */
        @Override
         ...
         *
         * @see
         * pl.polidea.test.TouchGestureDetector.TouchGestureListener#onMove()
         */
        @Override
         ...
         *
         * @see
         * pl.polidea.test.TouchGestureDetector.TouchGestureListener#onRelease
         * ()
         */
        @Override
         ...
         *
         * @see
         * pl.polidea.gesturedetector.TouchGestureDetector.TouchGestureListener
    ...
    /** The listener. */
    private final TouchGestureListener listener;
     ...
     *            the listener
     */
    public TouchGestureDetector(TouchGestureListener listener) {
        if (listener == null) {
